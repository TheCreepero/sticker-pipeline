...
from ui.views_mockup import MockupView
...
class StickerStudioApp(ctk.CTk):
    def __init__(self):
        ...
        self.btn_mockup = ctk.CTkButton(self.sidebar_frame, text="Mockup Calibrator", command=self.show_mockup_view)
        self.btn_mockup.grid(row=2, column=0, padx=20, pady=10)

        self.btn_catalog = ctk.CTkButton(self.sidebar_frame, text="Listings & Exports", command=self.show_catalog_view)
        self.btn_catalog.grid(row=3, column=0, padx=20, pady=10)
        ...
        self.mockup_view = MockupView(self)
    ...
    def hide_all_views(self):
        ...
        self.mockup_view.grid_forget()
        
        self.btn_builder.configure(fg_color="transparent")
        self.btn_mockup.configure(fg_color="transparent")
    ...
    def show_mockup_view(self):
        self.hide_all_views()
        self.mockup_view.grid(row=0, column=1, sticky="nsew", padx=10, pady=10)
        self.btn_mockup.configure(fg_color=["#3B8ED0", "#1F6AA5"])
